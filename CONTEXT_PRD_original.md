...
- **Storage Layer**: PostgreSQL for relational conversation logs and vectorized compressions (unified storage).
...
```
 ...
 - **PostgreSQL**: Stores conversation history and compressed vectors (unified storage).
